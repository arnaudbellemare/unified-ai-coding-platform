        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            potentialAction: {
              '@type': 'BuyAction',
              target:
                typeof window !== 'undefined' ? window.location.href : 'http://localhost:3001/store/demo-checkout',
              price: amount,
              priceCurrency: 'USDC',
            },
            geoOptimized: true,
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
                    ...
                    <p className="text-blue-700 text-sm mb-4">
                      Experience our GEO-optimized checkout with Coinbase branding, dynamic pricing, and AI agent
                      compatibility.
                    </p>
