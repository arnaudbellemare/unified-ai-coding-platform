        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div className="text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-gray-300 mb-4">
              Complete AI Shopping Ecosystem
            </h2>
            <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              The world's first platform integrating ACP (human-to-business), AP2 (agent-to-agent), 
              and GEO optimization for complete agentic commerce coverage.
            </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-thin text-black mb-2 group-hover:text-blue-800 transition-colors duration-300">Human-to-Business</h3>
                <p className="text-gray-600 font-light">When customers ask AI "Find me a blue shirt under $50" and AI finds your product</p>
              </div>
              <button 
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-thin text-black mb-2 group-hover:text-blue-800 transition-colors duration-300">Agent-to-Agent</h3>
                <p className="text-gray-600 font-light">AI agents pay each other for services, recommendations, and data access</p>
              </div>
              <button 
                onClick={() => {
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer group">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-thin text-black mb-2 group-hover:text-blue-800 transition-colors duration-300">GEO Services</h3>
                <p className="text-gray-600 font-light">Complete ACP & AP2 integration services with our proprietary optimization</p>
              </div>
              <button 
                onClick={() => {
          ...
          {payments.length === 0 ? (
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="text-sm text-gray-600">
                      {payment.description || 'Agent payment'}
                    </div>
                  </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-3xl p-8 border border-blue-500/20">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-400">We optimize your business to be discovered and recommended by AI research and AI agents</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-gray-800/50 rounded-2xl p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    When AI agents help customers shop, they can find and purchase from your business 
                    because we implement the protocols that AI agents use for commerce.
                  </p>
                  <ul className="text-gray-300 space-y-2">
            ...
            <div className="text-center mt-16">
              ...
              <p className="text-lg text-gray-400 mb-8">Complete AI Ranking + AI Shopping + AI Payments implementation to dominate AI search results and enable instant AI commerce</p>
          ...
          <div className="bg-gray-900 rounded-3xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-400 text-sm">Multi-objective optimization algorithms that race different strategies</p>
              </div>
              <div>
